...
async function connectRoomViaDirection(room: any, validDirection: any, nextRoom: any) {
	await workspace.openTextDocument(room.filePath)
...
export async function connectRoomsWithProperties(fromRoom: any, toRoom: any, validDirection1: any, validDirection2: any) {
