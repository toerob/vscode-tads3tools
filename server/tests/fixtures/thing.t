 ...
 class Thing: VocabObject
         ...
         propertyset '*DobjLookIn'
    {
        ...
        action()
        {
         ...
         propertyset '*DobjSearch' {         preCond { return preCondDobjLookIn; }         verify() { verifyDobjLookIn; }         remap() { return remapDobjLookIn; }         check() { checkDobjLookIn; }         action() { actionDobjLookIn; }     }
...
;
         ...
         propertyset '*DobjPushTravel'
    {
        ...
        verify() { ((libGlobal.curVerifyResults).addResult(new IllogicalVerifyResult(&cannotPushTravelMsg))); }
          ...
          propertyset '*DobjPushTravelThrough' {         preCond { return preCondDobjPushTravel; }         verify() { verifyDobjPushTravel; }         remap() { return remapDobjPushTravel; }         check() { checkDobjPushTravel; }         action() { actionDobjPushTravel; }     }          propertyset '*IobjPushTravelThrough'     {         verify()             { (libGlobal.curAction).verifyPushTravelIobj(self, GoThroughAction); }     }
         propertyset '*DobjPushTravelEnter' {         preCond { return preCondDobjPushTravel; }         verify() { verifyDobjPushTravel; }         remap() { return remapDobjPushTravel; }         check() { checkDobjPushTravel; }         action() { actionDobjPushTravel; }     }          propertyset '*IobjPushTravelEnter'     {         verify()             { (libGlobal.curAction).verifyPushTravelIobj(self, EnterAction); }     }
         propertyset '*DobjPushTravelGetOutOf' {         preCond { return preCondDobjPushTravel; }         verify() { verifyDobjPushTravel; }         remap() { return remapDobjPushTravel; }         check() { checkDobjPushTravel; }         action() { actionDobjPushTravel; }     }          propertyset '*IobjPushTravelGetOutOf'     {         verify()             { (libGlobal.curAction).verifyPushTravelIobj(self, GetOutOfAction); }     }
         propertyset '*DobjPushTravelClimbUp' {         preCond { return preCondDobjPushTravel; }         verify() { verifyDobjPushTravel; }         remap() { return remapDobjPushTravel; }         check() { checkDobjPushTravel; }         action() { actionDobjPushTravel; }     }          propertyset '*IobjPushTravelClimbUp'     {         verify()             { (libGlobal.curAction).verifyPushTravelIobj(self, ClimbUpAction); }     }
         propertyset '*DobjPushTravelClimbDown' {         preCond { return preCondDobjPushTravel; }         verify() { verifyDobjPushTravel; }         remap() { return remapDobjPushTravel; }         check() { checkDobjPushTravel; }         action() { actionDobjPushTravel; }     }          propertyset '*IobjPushTravelClimbDown'     {         verify()             { (libGlobal.curAction).verifyPushTravelIobj(self, ClimbDownAction); }     }
;
